...
- **10/10**: Apresentação da disciplina. Aplicação de questionário. Revisão dos conceitos básicos. 

- **17/10**: Intervalo de confiança para uma amostra. Teste de hipótese para duas amostras.

- **24/10**: Modelo de regressão linear simples e múltiplo.  

- <span style="color:red">**31/10**</span>: Representação gráfica.

- **07/11**: Análise de variância.

- **14/11**: Análise de agrupamentos. Modelo de classificação.

---

- **~~21/11~~**: Recesso

- **28/11**: Elaboração do resumo expandido.

- **05/12**: Elaboração do resumo expandido.

- **12/12**: Elaboração do resumo expandido.

- **19/12**: Avaliação de recuperação.
...
&#10004; Disciplina: 2025 - Estatística Aplicada
