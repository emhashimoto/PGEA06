...
subtitle: "Análise de regressão e correlação"
...
knitr::include_graphics('figuras/rio_bonito_nov2025.png')
```
...
<fieldset class="fldsetblock-class">
  ...
  Recentemente, um tornado com ventos de até 250 km/h atingiu a região de Rio Bonito. Pesquisadores registraram a velocidade do vento em diferentes pontos da cidade e estimaram o percentual de residências danificadas em cada local. 
</fieldset>
...
Com base nos dados de velocidade do vento e percentual de residências danificadas nos diferentes pontos da cidade de Rio Bonito, calcule o coeficiente de correlação de Pearson e interprete.

---

#Fechamento

Sequencia cronologica das atividades
