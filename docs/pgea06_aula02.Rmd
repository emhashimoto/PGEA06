...
knitr::include_graphics('https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExdDA1dnFwbGRuajUyZGlld2V5dm5ucjA4djRicWdiNDFqN2o3ODZhZiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/MpInizA3qTMYPEDwHx/giphy.gif')
```
...
- Em qual dos locais há maior concentração de poluentes?
...
🧰 Fixando uma probabilidade, permite a tomada de decisões com base **científica**.


```{r , echo=FALSE, fig.align = 'center', out.width = '40%'}
knitr::include_graphics('https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExbnl5am40aG5meHhmenJ3NzJhNW16Z3JhZnI3Y2NwZmllbGE3cXdmYyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/dBVjLe3lwfczBgY1M7/giphy.gif')
```
...
✅ 1. As amostras são independentes ou dependentes?

✅ 2. O tamanho de cada amostra é suficientemente grande?

✅ 3. Cada uma das amostras segue distribuição normal?

✅ 4. Em caso afirmativo do item 2 ou 3, qual faixa de valores plausíveis para cada amostra?

✅ 5. Qual teste de hipótese é utilizado: teste paramétrico ou teste não paramétrico?

✅ 6. Existe diferença significativa entre as amostras?
...
- Subcapítulos 11.1 até 11.2

- Subcapítulo 11.4.1

- Subcapítulo 11.7 até 11.8
]
...
Faça uma análise estatística para avaliar a altura média das plantas entre as duas áreas (industrial e rural). Fixe o nível de significância e o coeficiente de confiança.Utilize as questões dos exemplos anteriores.
